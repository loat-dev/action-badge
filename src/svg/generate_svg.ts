...
<svg xmlns="http://www.w3.org/2000/svg" width="${totalWidth}" height="20">
  ...
  <defs>
    ...
    <linearGradient id="state-fill" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop stop-color="${colors.GREY.start}" offset="0%"/>
      <stop stop-color="${colors.GREY.end}" offset="100%"/>
    </linearGradient>
  </defs>
  <g fill="none" fill-rule="evenodd">
    <g font-family="'DejaVu Sans',Verdana,Geneva,sans-serif" font-size="11px">
      ...
      <text fill="#010101" fill-opacity=".3" aria-hidden="true">
        <tspan x="22.1981982" y="15">${label}</tspan>
      </text>
      <text fill="#FFFFFF">
        <tspan x="22.1981982" y="14">${label}</tspan>
      </text>
    </g>
